...
################################################################################
## Form generated from reading UI file 'MRPC_UI_9XYWxEj.ui'
##
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:700;\">Check Resistivity</span></p></body></html>", None))
        self.groupBox_1.setTitle(QCoreApplication.translate("Form", u"UH 4-LH20", None))
        self.radioButton_1.setText(QCoreApplication.translate("Form", u"> 20M", None))
        self.radioButton_2.setText(QCoreApplication.translate("Form", u"< 20M", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("Form", u"UH1-LH21", None))
        self.radioButton_3.setText(QCoreApplication.translate("Form", u"> 20M", None))
        self.radioButton_4.setText(QCoreApplication.translate("Form", u"< 20M", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("Form", u"UH2-LH6", None))
        self.radioButton_5.setText(QCoreApplication.translate("Form", u"> 20M", None))
        self.radioButton_6.setText(QCoreApplication.translate("Form", u"< 20M", None))
