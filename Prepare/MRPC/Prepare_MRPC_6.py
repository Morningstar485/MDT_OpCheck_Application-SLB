...
################################################################################
## Form generated from reading UI file 'MRPC_UI_6PMQUAx.ui'
##
...
"}")
        ...
        self.checkBox_2.setEnabled(False)  # Initially disabled, will be enabled by the wizard
        self.label_4.hide()

        self.checkBox_1.toggled.connect(self.checkBox_2.setEnabled)
        self.checkBox_2.toggled.connect(self.label_4.setVisible)
    ...
    def retranslateUi(self, Form):
        ...
        self.checkBox_1.setText(QCoreApplication.translate("Form", u"Please Pull the MRPC Housing and connect wire as shown\n"
"in fig at upper head and do ET-1 before installing Housing", None))
        ...
        self.label_4.setText(QCoreApplication.translate("Form", u"<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:700;\">Please Move Back and Check Continuity Again</span></p></body></html>", None))
    # retranslateUi
